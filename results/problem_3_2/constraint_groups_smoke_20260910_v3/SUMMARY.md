...
The official all-island network was solved for **24 hours**. It produced **8 directional near-congestion modes**, retained as overlapping constraint groups with **217 bus memberships**, and condensed into **8 non-exclusive merged mode groups** only where both membership and relief-vector tests passed.
...
- Sampled independent LPF validation has maximum absolute error **5.228e-13**.
