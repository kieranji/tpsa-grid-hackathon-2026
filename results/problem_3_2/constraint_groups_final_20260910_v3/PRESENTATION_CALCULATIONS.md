...
Example top mode: 3581-89516-1::+1. Its maximum loading is 1.0000000000003806 pu and its event-weighted severity is 126.52270001369422 hours. Source: 01_directional_constraint_modes.csv, key mode_id=3581-89516-1::+1.
...
A 1 MW source injection is balanced over load in the same passive AC component, and two PyPSA LPFs measure the branch-flow delta. This is compared against the analytical PTDF in 09_lpf_sample_validation.csv. Maximum absolute error: 6.036e-13.
