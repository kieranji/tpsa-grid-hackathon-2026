...
- Backend: `pypsa`
- Cases completed: 4 / 4; failed: 0
- Financial horizon: 20 years; real discount rate: 7.0%
- Currency: real EUR, 2026 purchasing power; pre-tax unlevered
- Assumptions status: illustrative_distributed_bess_strict_tie_break_not_market_quotes
...
**bess / technical_max_net_RE_gain**: `bess_0132aed50d` @ `Croaghonagh;Binbane;Ardnagappary`, NPV €-81,740,933.
