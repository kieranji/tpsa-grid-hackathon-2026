...
- Run horizon: 24 snapshots / 24.0 hours
...
Priority status protects 334.882307 MWh across farms with reduced dispatch-down and transfers 334.882307 MWh of additional burden to farms with increased dispatch-down. Protection and burden need not be equal when the priority rule changes total technically feasible wind energy.
...
- Largest additional burden: Clogher wind at Clogher, +167.100083 MWh.
- Largest protected amount: Drumkeen wind at Drumkeen, -333.612140 MWh (negative means less dispatch-down).
