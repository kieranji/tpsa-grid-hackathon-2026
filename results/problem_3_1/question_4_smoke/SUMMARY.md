...
**bess / technical_max_net_RE_gain**: `bess_2f44561feb` @ `Ardnagappary`, NPV €-29,178,370.

**bess / economic_max_conditional_NPV**: `NO_BUILD` @ `-`, NPV €0.

**hybrid / technical_max_net_RE_gain**: `hybrid_b02cfea631` @ `Ardnagappary`, NPV €-65,364,040.

**hybrid / economic_max_conditional_NPV**: `NO_BUILD` @ `-`, NPV €0.

**wind / technical_max_net_RE_gain**: `wind_9b2f3a3485` @ `Ardnagappary`, NPV €-19,548,604.
