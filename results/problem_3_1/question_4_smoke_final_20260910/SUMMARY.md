...
- Backend: `pypsa`
- Cases completed: 3 / 3; failed: 0
- Financial horizon: 3 years; real discount rate: 7.0%
- Currency: real EUR, 2026 purchasing power; pre-tax unlevered
- Assumptions status: illustrative_not_an_irish_market_forecast
- Annualisation: {'mode': 'repeat_block', 'hours_per_year': 8760.0}

SMOKE TEST ONLY — the shortened time series and project life cannot support investment conclusions.
## Comparison basis
...
**bess / technical_max_net_RE_gain**: `bess_1a00ab89cb` @ `Ardnagappary`, NPV €-29,178,370.

**bess / economic_max_conditional_NPV**: `NO_BUILD` @ `-`, NPV €0.

**hybrid / technical_max_net_RE_gain**: `hybrid_39b0bceac4` @ `Ardnagappary`, NPV €-65,364,040.

**hybrid / economic_max_conditional_NPV**: `NO_BUILD` @ `-`, NPV €0.

**wind / technical_max_net_RE_gain**: `wind_a70aa07f9b` @ `Ardnagappary`, NPV €-19,548,604.

**wind / economic_max_conditional_NPV**: `NO_BUILD` @ `-`, NPV €0.
